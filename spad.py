...
main_application.title('Ishrat Text Editor')
...
def find_func(event=None):
    ...
    text_relace_label=ttk.Label(find_frame,text='Replace')
    ...
    text_relace_label.grid(row=1,column=0,padx=4,pady=4)
...
view.add_checkbutton(label='Tool Bar',image=tool_bar_icon,onvalue=True,offvalue=0,compound=tk.LEFT,variable=show_toolbar,command=hide_toolbar)
view.add_checkbutton(label='Status Bar',image=status_bar_icon,onvalue=1,offvalue=False,compound=tk.LEFT,variable=show_statusbar,command=hide_statusbar)
